...
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum, isPending) VALUES ("smitze01","Zechariah","Smith", "admin", 1, 65, 3, true);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum) VALUES ("mayeis01","Isaiah","Mayerchak", "admin", 1, 120, 1);
INSERT INTO Users (userName, firstName, lastName, credits, roomDrawNum) VALUES ("saudih01","Ihab","Saud", "admin", 85, 2);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum, isPending) VALUES ("test01","Testy","McTest", "student", 1, 1, 4, true);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum) VALUES ("test02","Testy","Test", "student", 3, 2, 5);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum) VALUES ("test03","Testy","MacTest", "student", 3, 3, 6);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum) VALUES ("test04","Testy","Testerson", "student", 4, 4, 7);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum) VALUES ("test05","Testy","Testus", "student", 4, 5, 8);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum) VALUES ("test06","Testy","Tester", "student", 8, 6, 9);
INSERT INTO Users (userName, firstName, lastName, credits, roomDrawNum) VALUES ("test07","Testy","Testin", "student", 7, 10);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum) VALUES ("test08","Testy","Testenheimer", "student", 7, 8, 11);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum) VALUES ("test09","Testy","Testbuscus", "student", 6, 9, 12);
INSERT INTO Users (userName, firstName, lastName, credits, roomDrawNum) VALUES ("test10","Testy","Testicule", "student", 10, 13);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum) VALUES ("test11","Testy","McT", "student", 2, 11, 14);
INSERT INTO Users (userName, firstName, lastName, credits, roomDrawNum) VALUES ("test12","Testy","Testeese", "student", 12, 15);
INSERT INTO Users (userName, firstName, lastName, gId, credits, roomDrawNum) VALUES ("test13","Testy","Testington", "student", 5, 13, 16);
